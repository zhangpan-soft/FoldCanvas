...
M14 把已经验收的 M00-M13 行为冻结为 `1.0.0-rc.1`，只承诺真实跑过完整证据的
Unity `6000.3.20f1`。候选包除了确定性 `.tgz` 与 SHA-256，还会生成逐文件哈希
清单和 RC 证据，并把安装、问题复现、安全报告、精确提交审计与从二维源回滚的
流程写入包内文档。它不是最终 `1.0.0`，也不会自动发布到外部商城。详见
